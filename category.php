...
<?php 
	...
	$pr = new Product;
	$prods=$pr->selectCondition("cat_id=$id","id,name,img,price");
				...
				<div class="col-lg-3">
					...
					<div class="shop_sidebar">
						<div class="sidebar_section">
							...
							<?php foreach ($cats as $catone) :?>
								
								<li><a href="category.php?id=<?=$catone['id'] ?>"><?= $catone['name']?> <i class="fas fa-chevron-right ml-auto"></i></a></li>
